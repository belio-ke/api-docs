...
| :------------------------------------------ | :----------------------------------------------------- |
| [Send Messages](/send-message/introduction) | Send messages using `sendToEach` or `sendToMany` modes |
| [List Services](/service/list)              | Retrieve services                                      |
| [List Bundles](/bundle/list)                | Retrieve bundles for a product type                    |
